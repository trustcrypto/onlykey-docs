...
description: "The user's guide provides step-by-step instructions for configuring and using OnlyKey DUO."
slug: duousersguide
...
Using the backup file created in the [Secure Encrypted Backup Anywhere](/duousersguide#secure-encrypted-backup-anywhere) section, OnlyKey can be restored to a previous state. This also allows restoring to a different OnlyKey or a second OnlyKey in order to have an extra.
...
:::callout
**Step 1.** Ensure that the same passphrase/key is loaded onto the OnlyKey that was used to backup.
:::
...
![](/assets/firmware-duo.png)

- Download <a href="https://github.com/trustcrypto/OnlyKey-Firmware/releases/download/v3.0.4-prod/Signed_OnlyKey_3_0_4_STD.txt" target="_blank" download>OnlyKey DUO firmware</a>
...
<table>
  ...
  <tr>
   ...
   <td>If full wipe mode is enabled (disabled by default) the OnlyKey will wipe both data and firmware. Follow instructions in the <a href="/duousersguide#loading-onlykey-firmware">upgrade guide here</a> to load firmware.
   </td>
  </tr>
  <tr>
